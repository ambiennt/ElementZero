...
namespace VanillaBlockTypes {
    ...
    MCAPI extern WeakPtr<BlockLegacy> mFlowingLava;
    MCAPI extern WeakPtr<BlockLegacy> mFlowingWater;
    ...
    MCAPI extern WeakPtr<BlockLegacy> mSpuceFenceGate;
    ...
    MCAPI extern WeakPtr<BlockLegacy> mStillLava;
    MCAPI extern WeakPtr<BlockLegacy> mStillWater;
