...
constexpr const char* dumpMode(Mode mode) {
	switch (mode) {
...
public:
	...
	static void setup(CommandRegistry *registry) {
		...
		addEnum<Mode>(registry, "spawn-protection-mode", {
		...
		registry->registerOverload<SpawnProtectionCommand>(
				"spawn-protection", mandatory<CommandParameterDataType::ENUM>(&SpawnProtectionCommand::target_mode, "mode", "spawn-protection-mode"));
	}
};
